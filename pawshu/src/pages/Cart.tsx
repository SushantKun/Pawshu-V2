          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                {cartItems.map(item => (
                  <div key={item.id} className="flex items-center p-6 border-b dark:border-gray-700 last:border-b-0">
                    <img
                      src={item.image}
                      alt={item.name}
                      ...
                      <div className="mt-2 flex items-center space-x-4">
                        <div className="flex items-center border dark:border-gray-600 rounded">
                          <button
                            ...
                            className="px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-900 dark:text-white transition-colors"
                          >
                            -
                          </button>
                          <span className="px-3 py-1 border-x dark:border-gray-600 text-gray-900 dark:text-white">{item.quantity}</span>
                          <button
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
                            className="px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-900 dark:text-white transition-colors"
                          >
