      ...
      <div className="p-4 border-b border-blue-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-blue-300">{doctorInfo?.specialization || 'Veterinarian'}</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto py-4">
        <ul className="space-y-2 px-2">
          <li>
            <Link 
              to="/doctor/dashboard" 
              className={`flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg ${isActive('/doctor/dashboard')}`}
            >
          ...
          <li>
            <Link 
              ...
              className={`flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg ${isActive('/doctor/appointments')}`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <Link 
              to="/doctor/profile" 
              className={`flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg ${isActive('/doctor/profile')}`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
